...
export default class Drop extends React.Component {
    ...
    render() {
        return (
            <div id={this.props.id} onDrop={this.drop} onDragOver={this.allowDrop} style={this.props.style} style={{ width: "'200%'", height: "'200%'", display: 'flex', color: '#00000000', margin: '0' }}>
                {this.props.children}
            </div>
        )
    }
