            ...
            <div id="containerPageMenu">
                ...
                <div id="containerLogin">
                    ...
                    <form onSubmit>
                        ...
                        <input className="buttonLogin buttonLogin-animated buttonLogin-white branco maior" id='1_menu' type="submit" value="Gerenciar" onClick={this.abrirGerenciar.bind(this)} />
